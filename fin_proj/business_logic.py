...
def get_list_of_all_words(dir: str) -> list:
    paths_to_all_files = get_names_of_files(dir)["roots_of_files"]
    all_words = preparing_files_for_word_analysis(paths_to_all_files)
    return all_words


def group_word_info(word: str) -> dict:
    average_len_of_words = get_average_word_len(word)
    ...
    word_info = {
        "len of word": average_len_of_words,
        "count of vowels": count_of_vowels,
        "count of consonants": count_of_consonants,
        "syllables": syllables,
    }
